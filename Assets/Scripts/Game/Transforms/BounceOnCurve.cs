...
public class BounceOnCurve : MonoBehaviour, Types.IRoom_EnemyObject
{
	[SerializeField] private Curve m_CurveComponent = null;
	...
	{
		GAssert.Assert(null != m_CurveComponent, "BounceOnBezierCurve setup without a Bezier component!");
	...
	void Update()
	{
		...
		transform.position = m_CurveComponent.GetPoint(Easing.EaseInOut(fDir, m_iEasing));
	}
}